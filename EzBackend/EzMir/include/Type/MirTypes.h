...
class MirTypes
{
  public:
    ...
    void initialize(MirEmitterContext *ctx)
    {
        ...
        m_voidType = m_ctx->createType(MirTypeKind::Void, 0, nullptr, "i8");
        ...
        m_int64Type = m_ctx->createType(MirTypeKind::Integer, 8, nullptr, "i32");

        m_float32Type = m_ctx->createType(MirTypeKind::FloatingPoint, 4, nullptr, "f32");
        m_float64Type = m_ctx->createType(MirTypeKind::FloatingPoint, 8, nullptr, "f32");
    }
