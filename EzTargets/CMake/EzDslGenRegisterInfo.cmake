# EzTargets/CMake/EzDslGenRegisterInfo.cmake
...
by executing EzDslCli and generating <Target>RegisterInfo.h.
...
#]=======================================================================]
function(EzDslGenRegisterInfo)
    cmake_parse_arguments(PARSE_ARGV 0 EZDSL "" "TARGET;INPUT;TARGET_NAME;OUTPUT_DIR;NAMESPACE_ROOT" "")

    if(NOT EZDSL_TARGET)
        message(FATAL_ERROR "EzDslGenRegisterInfo: TARGET argument is required.")
    endif()

    if(NOT EZDSL_INPUT)
        message(FATAL_ERROR "EzDslGenRegisterInfo: INPUT argument is required.")
    endif()
    ...
    set(GEN_HEADER "${EZDSL_OUTPUT_DIR}/${EZDSL_TARGET_NAME}RegisterInfo.h")
    ...
    add_custom_command(
        ...
        COMMENT "[EzDSL] Synthesizing ${EZDSL_TARGET_NAME}RegisterInfo from ${EZDSL_INPUT}"
        VERBATIM
    )
