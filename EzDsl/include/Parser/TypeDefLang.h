...
struct TypeKind
{
    static constexpr auto Table =
            lexy::symbol_table<Ast::TypeDef::TypeKind>.map(LEXY_LIT("integer"), Ast::TypeDef::TypeKind::Integer).map(LEXY_LIT("float"), Ast::TypeDef::TypeKind::FloatingPoint);
...
struct TypeDescriptor
{
    ...
    static constexpr auto rule =
            dsl::p<TypeKind> + dsl::p<Common::Identifier> + dsl::parenthesized(dsl::p<Common::IntegerLiteral>);
