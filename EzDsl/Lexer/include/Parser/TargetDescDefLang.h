 ...
 */
using TargetDescItem = std::variant<std::pair<Common::Keyword<"registers">, Ast::Common::StringLiteral>,
                                    std::pair<Common::Keyword<"instructions">, Ast::Common::StringLiteral>,
                                    std::pair<Common::Keyword<"calling_convs">,
                                              std::pmr::vector<Ast::Common::StringLiteral>>,
                                    ...
                                    std::pair<Common::Keyword<"object_formats">,
...
struct LibcallsDecl
{
    ...
    {
        static constexpr auto whitespace = Common::Whitespace;
        static constexpr auto rule = dsl::curly_bracketed.opt_list(dsl::p<LibcallEntryParser>, dsl::sep(dsl::lit_c<';'>));
...
struct ComponentsDecl
{
    ...
    {
        static constexpr auto whitespace = Common::Whitespace;
        static constexpr auto rule = dsl::curly_bracketed.opt_list(dsl::p<ComponentEntryParser>, dsl::sep(dsl::lit_c<';'>));
...
struct BodyEntry
{
    ...
    static constexpr auto value = lexy::callback<TargetDescItem>(
            [](TargetDescItem item, auto...) { return item; });
};
