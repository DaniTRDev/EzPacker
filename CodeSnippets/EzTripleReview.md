...
- [ ] **P1 · DUP-01 — `widenScalarTo`/`narrowScalarTo` and source variants are twins**
...
- [ ] **P1 · DUP-03 — "insert first, then switch insertion point" lambda repeated 4–5×**
...
- [ ] **P1 · DUP-04 — Extension-opcode selection repeated three times**
...
- [ ] **P1 · DUP-05 — ELF/COFF descriptors are structurally identical**
...
- [ ] **P1 · DUP-06 — `findClass` duplicated hand-written vs generated**
...
- [ ] **P1 · DUP-07 — Hand-written register setup duplicates `.reg` source**
...
- [ ] **P1 · DUP-08 — `data/*.ezcc` duplicate the in-target calling conventions**
...
- [ ] **P2 · DUP-09 — `Predicates` re-implements helpers now generated/handwritten elsewhere**
...
- [ ] **P1 · LEG-01 — The entire `Predicates` module is dead**
...
- [ ] **P1 · LEG-02 — Register-file generation is orphaned and targets the removed `TableGen` namespace**
...
- [ ] **P1 · LEG-03 — Target-descriptor generation is orphaned with `TableGen` leftovers**
...
- [ ] **P1 · LEG-04 — Other orphaned target source-of-truth files**
...
- [ ] **P1 · LEG-06 — Unreferenced methods**
...
- [ ] **P1 · LEG-07 — Addressing-mode folding is test-only, not wired into production selection**
...
- [ ] **P1 · LEG-08 — `getLibcallStr` is a stale libcall id-space**
...
- [ ] **P1 · LEG-09 — `MirRegisterAllocatorPass::getDependencies` TODO returns `{}`**
...
- [ ] **P2 · LEG-11 — `LoweredBlock` alias and `m_loweredBlocks` allocator**
...
- [ ] **P1 · WEI-04 — Call detection and bank identity by string**
...
- [ ] **P1 · WEI-05 — `X86_64TargetDesc::initialize()` is not idempotent**
...
- [ ] **P2 · WEI-06 — Mixed ownership across the target seam**
...
- [ ] **P2 · WEI-07 — `MirAddressingModeMatcher::getDef` can scan the whole module**
...
- [ ] **P2 · WEI-09 — `std::format(...).c_str()` temporaries fed to `buildPhysReg`**
...
- [ ] **P1 · OPT-01 — `getAvailable*` returns `pmr::vector` by value in hot paths**
...
- [ ] **P1 · OPT-02 — `findClass` is a linear scan per constraint**
...
- [ ] **P1 · OPT-03 — `calculateSpillCost` dead loop weighting and O(n²) rescans**
...
- [ ] **P1 · OPT-04 — `selectPHI` scans the whole function twice per PHI**
  - Where: `src/Targets/X86_64/X86_64InstructionSelector.cpp:544-603`
  - Fix: use `MirFunctionRegisterInfo::getUses`.
  - Status: new

- [ ] **P1 · OPT-05 — Unconditional `MirPrinter::printToString` on trace/debug paths**
...
- [ ] **P1 · OPT-06 — 27 `const_cast<MirTargetInstructionDesc*>`**
...
- [ ] **P2 · OPT-07 — `std::format("...").c_str()` for literals / operand names**
...
- [ ] **P2 · OPT-08 — Missing `reserve` on operand vectors**
...
- [ ] **P2 · OPT-11 — Dead locals causing warnings**
...
| OPT-01..06 | P1 | Optimization | new | — | target lookup/spill/const_cast |
| DUP-09..10, LEG-10..11, WEI-06..10, OPT-07..12 | P2 | mixed | new | — | polish |
