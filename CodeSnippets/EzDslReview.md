...
- [x] **P1 · DUP-03 — Generator boilerplate repeated across all ten generators**
...
- [x] **P1 · DUP-07 — `Driver.cpp` keeps five parallel `GeneratorKind` chains**
...
- [x] **P1 · DUP-08 — Driver/generator path-resolution logic duplicated and divergent**
...
- [x] **P1 · DUP-09 — Enum→string mapping duplicated between InfoDumper and generators**
...
- [x] **P1 · DUP-10 — Sema pass preamble/loop scaffolding repeated in all nine passes**
...
- [x] **P1 · LEG-03 — Register semantic payload mostly write-only**
...
- [x] **P1 · LEG-08 — `InfoDumper::dumpSymbols` is stale**
...
- [x] **P2 · LEG-09 — Stale CLI help/error text**
...
- [x] **P2 · LEG-10 — README out of date**
...
- [x] **P1 · WEI-06 — Driver and generator disagree on output-path interpretation**
...
- [x] **P2 · WEI-10 — Default dialect depends on static-init order**
...
- [x] **P1 · OPT-02 — Symbol/AST data collected 2–3× per generator**
...
- [x] **P2 · OPT-04 — `InfoDumper` enum→string helpers allocate and take `int`**
...
- [x] **P2 · OPT-06 — Repeated work in `CommandLineOptions::parse`**
  - Where: `CommandLineOptions.cpp:218-221,245-259,279-318`
  - Fix: option→generator table; one lowercase helper.
  - Status: fixed

- [x] **P2 · OPT-07 — Driver classifies outputs via `path.string()` map keys**
...
| --- | --- | --- | --- | --- | --- |
| WEI-01..10 | P1/P2 | Weird | fixed | — | backend re-resolve, boundary sanitize, atomic writes, diagnostics, eof, default dialect |
| DUP-01..12 | P1/P2 | Duplication | fixed | — | shared string/collect/vocabulary/generator/path/enum/pass helpers (XPR-02/03/10) |
| LEG-01..03, LEG-05..12 | P1/P2 | Legacy | fixed | — | dead SemaContext/wrappers/helpers, InfoDumper/CLI/README, test rename, PCH trim |
| LEG-04 | P2 | Legacy | wontfix | — | target-instruction payload retained for consumers; emitting it changes generated text |
| OPT-01..07 | P1/P2 | Optimization | fixed | — | interning, collection, string_view returns, driver tables, path keys |
