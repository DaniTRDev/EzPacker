...
- [ ] **P1 · DUP-01 — `sanitizeIdentifier` copied four times**
...
- [ ] **P1 · DUP-02 — `ToUpper` copied five times**
...
- [ ] **P1 · DUP-04 — `collect*Symbols` scan reimplemented 13×**
...
- [ ] **P1 · DUP-05 — Registry pattern duplicated (encoding dialect vs codegen backend)**
...
- [ ] **P1 · DUP-06 — x86 vocabulary stored twice (must stay in sync)**
...
- [ ] **P2 · DUP-11 — `SymbolTable::getSymByName` implemented twice**
  - Where: `Sema/src/Sema/SymbolTable.cpp:40-56` vs `:58-74`
  - Fix: one implementation with an optional `SymbolType`.
  - Status: new

- [ ] **P2 · DUP-12 — Hand-written banner in `CppLegalizeRuleGenerator`**
...
- [ ] **P1 · LEG-01 — `SemaContext` is a dead class**
...
- [ ] **P1 · LEG-02 — Six unused free-function generator wrappers**
...
- [ ] **P1 · LEG-07 — `RealLiteral` parser unused**
...
- [ ] **P2 · LEG-11 — Stale test naming from the encoding rename**
...
- [ ] **P2 · LEG-12 — CodeGenerators PCH still pulls all of lexy**
...
- [ ] **P1 · WEI-01 — `setTargetName` desyncs the resolved backend**
...
- [ ] **P1 · WEI-02 — Target-name sanitization is inconsistent; `x86-64` yields invalid C++**
...
- [ ] **P1 · WEI-03 — `WriteFileIfChanged` is documented atomic but is not**
...
- [ ] **P1 · WEI-04 — Encoding decoded twice; codegen fails silently**
...
- [ ] **P1 · WEI-05 — `.tyf`/`.reg`/`.tdesc` parsers accept trailing garbage**
...
- [ ] **P1 · OPT-01 — O(n²) string interning in the legalizer generator**
...
- [ ] **P1 · OPT-03 — `EncodingCodegenBackend` virtuals return `std::string` for constants**
...
- [ ] **P2 · OPT-05 — `WriteFileIfChanged` extra full copy**
...
| --- | --- | --- | --- | --- | --- |
| WEI-01..06 | P1 | Weird | new | — | backend desync/sanitize/atomicity/decode/parser/paths |
| DUP-01..10 | P1 | Duplication | new | — | sanitize/ToUpper/generators/registry/vocab/driver |
| LEG-01..08 | P1 | Legacy | new | — | dead classes/wrappers/payloads/helpers |
| OPT-01..03 | P1 | Optimization | new | — | interning/collection/string returns |
| DUP-11..12, LEG-09..12, WEI-07..10, OPT-04..07 | P2 | mixed | new | — | polish |
