...
- [ ] **P1 · DUP-01 — Two copies of instruction-statement parsing**
...
- [ ] **P1 · DUP-02 — Memory-operand parsing duplicated**
...
- [ ] **P1 · DUP-03 — `declareRegister` vs `getOrCreateRegister` near-identical**
...
- [ ] **P1 · DUP-04 — `MirOperandBuilder::buildMem` validates four times; int/float twins**
...
- [ ] **P1 · DUP-05 — `MirInstructionBuilder::build`/`buildTarget` triplicated**
...
- [ ] **P1 · DUP-06 — Instruction operand formatting duplicated in the printer**
...
- [ ] **P2 · DUP-07 — def/use unregistration copy-pasted**
...
- [ ] **P2 · DUP-08 — `ArgumentLocationDesc` stores a redundant discriminant**
...
- [ ] **P1 · LEG-01 — Unused second `MirFunctionBuilder` constructor (+ TODO)**
...
- [ ] **P1 · LEG-02 — `MirFunction::addCalleeSavedRegUse` is dead**
...
- [ ] **P1 · LEG-03 — Dead `CallLoweringState` API**
...
- [ ] **P1 · LEG-04 — Dead `MirTargetInstructionDesc` API**
...
- [ ] **P1 · LEG-05 — Dead `MirType` API; `m_isTrivial` constant**
...
- [ ] **P1 · LEG-06 — Dead public parser entry points**
...
- [ ] **P1 · LEG-07 — Unused global tables and context map**
...
- [ ] **P1 · LEG-08 — Dead file-scope `getRegInfo`**
...
- [ ] **P1 · LEG-09 — `MirPass::getResult()` is dead**
...
- [ ] **P1 · WEI-05 — Physical-register detection is a `"p"`-prefix hack with ignored errors**
...
- [ ] **P1 · WEI-06 — Lexer token "restore" hack**
...
- [ ] **P1 · WEI-07 — Ignored `matchToken` results and discarded syntax**
...
- [ ] **P1 · WEI-08 — Builders return half-constructed objects on error**
...
- [ ] **P2 · WEI-09 — `MirRegisterRef::operator<` orders by pointer address**
...
- [ ] **P2 · WEI-10 — Nondeterministic iteration in pipeline/SSA**
...
- [ ] **P2 · WEI-11 — `idom::intersect` uses `operator[]` (possible hang)**
...
- [ ] **P2 · WEI-13 — Null-deref hazards on public entry points**
...
- [ ] **P1 · OPT-01 — Eager `MirPrinter::printToString` in trace paths**
...
- [ ] **P1 · OPT-02 — `MirFunctionRegisterInfo::getUses` returns a copy**
...
- [ ] **P1 · OPT-03 — Per-instruction heap vectors in hot passes**
...
- [ ] **P1 · OPT-04 — `std::pmr::string` keys allocated on every symbol lookup**
...
- [ ] **P1 · OPT-05 — `getOpCodeFromStr` allocations / repeated lookups**
...
- [ ] **P1 · OPT-06 — `CallLoweringState` bank cursors key on `std::string`**
...
- [ ] **P2 · OPT-08 — Missing `reserve`/moves in builders and formatters**
...
- [ ] **P2 · OPT-09 — Redundant lookups / small API tightening**
