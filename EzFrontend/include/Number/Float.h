#ifndef EZPACKER_FLOAT_H
#define EZPACKER_FLOAT_H

#include "EzFrontendCommon.h"
#include "IBigNumber.h"

/**
 * This class wraps float type so it can be read / written easily.
 */
class Float : public IBigNumber
{
  public:
    /**
