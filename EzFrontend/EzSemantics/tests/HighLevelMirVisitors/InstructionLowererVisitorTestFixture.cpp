...
void InstructionLowererVisitorTestFixture::SetUp()
{
    ...
    m_errorCollector->addSubscriber(
            ...
            {
                InstructionLowererVisitorTestFixture *fixture = (InstructionLowererVisitorTestFixture *)userParam;
...
void InstructionLowererVisitorTestFixture::TearDown()
{
    m_visitor.reset();
