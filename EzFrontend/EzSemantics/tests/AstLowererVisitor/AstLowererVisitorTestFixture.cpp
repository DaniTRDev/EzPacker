...
void AstLowererVisitorTestFixture::SetUp()
{
    m_logger = EzLogger::createSyncLogger("TEST_LOWERING");
    ...
    m_tokenizer = std::make_shared<BasicTokenizer>(m_errorCollector, m_sourceManager, "TEST_LOWERING");
    ...
    m_errorCollector->addSubscriber(
            ...
            {
                AstLowererVisitorTestFixture *fixture = (AstLowererVisitorTestFixture *)userParam;
...
void AstLowererVisitorTestFixture::TearDown()
{
